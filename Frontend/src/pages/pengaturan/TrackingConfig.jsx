            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                <label className="flex items-center justify-between cursor-pointer p-5 border border-slate-100 rounded-xl hover:bg-slate-50 transition-colors shadow-sm">
                  ...
                  <div className="relative shrink-0">
                    ...
                    />
                    <div className={`block w-14 h-8 rounded-full transition-colors ${formData.is_open ? 'bg-emerald-500' : 'bg-slate-300'}`}></div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-700 font-medium bg-slate-50"
                >
